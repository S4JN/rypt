      ...
      <div className='flex flex-col items-center w-full mt-3'>
        <div className=' w-full mb-6 p-2'>
          <a href={`https://goerli.etherscan.io/address/${addressFrom}`} target="_blank" rel='noopener noreferrer'>
            <p className='text-white tex-base'>From: {shortenAddress(addressFrom)}</p>
          </a>

          <a href={`https://goerli.etherscan.io/address/${addressTo}`} target="_blank" rel='noopener noreferrer'>
            <p className='text-white tex-base'>To: {shortenAddress(addressTo)}</p>
          </a>
...
const Transactions = () => {
  ...
  return (
    <div className='flex w-full justify-center items-center 2xl:px-28 gradient-bg-transactions'>
      <div className='flex flex-col py-[100px] md:p-12 px-4'>
        {currentAccount ? (
